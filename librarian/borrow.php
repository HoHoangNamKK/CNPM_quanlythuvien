		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Bảng cho mượn</strong>
                                </div>
...
<div class="span3">
				...
				<option></option>
				<?php $result =  mysqli_query($conn,"select * from member"); 
				...
				<div class="control-group"> 
					<label class="control-label" for="inputEmail">Ngày hạn</label>
					<div class="controls">
				...
				<div class="control-group"> 
					<div class="controls">
								...
								<button name="delete_student" class="btn btn-success"><i class="icon-plus-sign icon-large"></i> Mượn</button>
					</div>
				</div>
				</div>
				<div class="span8">
						<div class="alert alert-success"><strong>Sách chọn</strong></div>
